...
interface CarouselProps {
  ...
  onButtonPressE: () => void; // Função de navegação para o primeiro botão
}
...
const Carousel: React.FC<CarouselProps> = ({ data, onButtonPressE }) => {
        ...
        {currentIndex === data.length - 1 && (
          <>
            <View style={styles.buttonRow}>
              <TouchableOpacity style={styles.button} onPress={onButtonPressE}>
                <View style={styles.buttonContent}>
                  <Text style={styles.buttonText}>Veja o edital</Text>
