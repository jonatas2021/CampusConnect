...
interface CarouselProps {
  data: Array<{
    ...
    email2: string; // Novo campo para email
  }>;
}
      ...
      {currentIndex === data.length - 1 && (
        <View style={styles.buttonContainer}>
          ...
          <View style={styles.buttonRow}>
            <TouchableOpacity
              style={styles.button}
              onPress={() => handleSendEmail(data[currentIndex].email2)}
            >
          <View style={styles.buttonContent}>
                <Text style={styles.buttonText}>Entrar em contato</Text>
                <MaterialIcons name="email" size={32} color="#fff" style={styles.icon} />
          ...
          <View style={styles.buttonRow}>
            <TouchableOpacity
              style={styles.button}
              onPress={() => handleCopyEmail(data[currentIndex].email2)}
            >
              <View style={styles.buttonContent}>
                <Text style={styles.buttonText}>Copiar Email</Text>
                <CopyButton style={styles.copyButton} />
