...
const BUS_URL =
  "https://raw.githubusercontent.com/CaioSousa32/campus-connect-data/main/bus_rodoturgo.json";

const STORAGE_KEY = "@bus_recifego_data";
const STORAGE_DATE_KEY = "@bus_recifego_last_update";
